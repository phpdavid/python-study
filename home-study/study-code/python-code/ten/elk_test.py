...
s = socket.socket()
s.connect(('192.168.109.130', 12345))
...
while line > 0:
    ...
    data = {'name': random.choice(users), 'visit_time': temp_time, 'device': random.choice(device),
            'page': random.choice(pages), 'num': random.randint(0, 10)}
